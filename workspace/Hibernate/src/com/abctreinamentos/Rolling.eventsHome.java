 ...
 * @see com.abctreinamentos.Rolling.events
 * @author Hibernate Tools
 */
public class eventsHome {

    private static final Log log = LogFactory.getLog(Rolling.eventsHome.class);
    ...
    public events findById( com.abctreinamentos.Rolling$eventsId id) {
        log.debug("getting events instance with id: " + id);
        try {
            events instance = (events) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Rolling$events", id);
            if (instance==null) {
    ...
    public List findByExample(events instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Rolling$events")
