...
import LogmnrRestartCkptTxinfo.;
 ...
 * @see com.abctreinamentos.LogmnrRestartCkptTxinfo.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrRestartCkptTxinfo.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrRestartCkptTxinfo$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrRestartCkptTxinfo$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrRestartCkptTxinfo$")
