 ...
 * @see com.abctreinamentos.Rolling.statistics
 * @author Hibernate Tools
 */
public class statisticsHome {

    private static final Log log = LogFactory.getLog(Rolling.statisticsHome.class);
    ...
    public statistics merge(statistics detachedInstance) {
        ...
        try {
            statistics result = (statistics) sessionFactory.getCurrentSession()
    ...
    public statistics findById( com.abctreinamentos.Rolling$statisticsId id) {
        log.debug("getting statistics instance with id: " + id);
        try {
            statistics instance = (statistics) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Rolling$statistics", id);
            if (instance==null) {
    ...
    public List findByExample(statistics instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Rolling$statistics")
