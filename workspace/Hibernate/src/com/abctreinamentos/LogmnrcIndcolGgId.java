...
/**
 * LogmnrcIndcolGgId generated by hbm2java
 */
public class LogmnrcIndcolGgId implements java.io.Serializable {
	...
	public LogmnrcIndcolGgId() {
	}

	public LogmnrcIndcolGgId(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal commitScn, BigDecimal intcol#) {
	...
	public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrcIndcolGgId) ) return false;
		 LogmnrcIndcolGgId castOther = ( LogmnrcIndcolGgId ) other; 
