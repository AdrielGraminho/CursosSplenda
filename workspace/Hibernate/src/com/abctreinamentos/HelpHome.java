...
/**
 * Home object for domain model class Help.
 * @see com.abctreinamentos.Help
 * @author Hibernate Tools
 */
public class HelpHome {

	private static final Log log = LogFactory.getLog(HelpHome.class);
	...
	public void persist(Help transientInstance) {
		log.debug("persisting Help instance");
		try {
	...
	public Help merge(Help detachedInstance) {
		...
		try {
			Help result = (Help) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Help findById(com.abctreinamentos.HelpId id) {
		log.debug("getting Help instance with id: " + id);
		try {
			Help instance = (Help) sessionFactory.getCurrentSession().get("com.abctreinamentos.Help", id);
			if (instance == null) {
	...
	public List findByExample(Help instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.abctreinamentos.Help")
