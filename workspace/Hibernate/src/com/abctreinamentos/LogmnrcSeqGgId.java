...
/**
 * LogmnrcSeqGgId generated by hbm2java
 */
public class LogmnrcSeqGgId implements java.io.Serializable {

	private BigDecimal logmnrUid;
	private BigDecimal obj#;
	private BigDecimal commitScn;

	public LogmnrcSeqGgId() {
	}

	public LogmnrcSeqGgId(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal commitScn) {
	...
	public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrcSeqGgId) ) return false;
		 LogmnrcSeqGgId castOther = ( LogmnrcSeqGgId ) other; 
