 ...
 * @see com.abctreinamentos.LogmnrProcessedLog.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrProcessedLog.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrProcessedLog$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrProcessedLog$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrProcessedLog$")
