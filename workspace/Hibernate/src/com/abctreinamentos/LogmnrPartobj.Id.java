...
/**
 * LogmnrPartobj.Id generated by hbm2java
 */
public class LogmnrPartobj.Id  implements java.io.Serializable {


     private BigDecimal logmnrUid;
     private BigDecimal obj#;

    public LogmnrPartobj.Id() {
    }

	
    public LogmnrPartobj.Id(BigDecimal obj#) {
        this.obj# = obj#;
    }
    public LogmnrPartobj.Id(BigDecimal logmnrUid, BigDecimal obj#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrPartobj.Id) ) return false;
		 LogmnrPartobj.Id castOther = ( LogmnrPartobj.Id ) other; 
