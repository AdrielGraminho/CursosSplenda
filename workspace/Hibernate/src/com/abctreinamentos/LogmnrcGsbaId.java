...
public class LogmnrcGsbaId implements java.io.Serializable {
	...
	public LogmnrcGsbaId() {
	}

	public LogmnrcGsbaId(BigDecimal logmnrUid, BigDecimal asOfScn) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LogmnrcGsbaId))
			return false;
		...
		return ((this.getLogmnrUid() == castOther.getLogmnrUid()) || (this.getLogmnrUid() != null
				...
				&& ((this.getAsOfScn() == castOther.getAsOfScn()) || (this.getAsOfScn() != null
						&& castOther.getAsOfScn() != null && this.getAsOfScn().equals(castOther.getAsOfScn())));
	}
