...
/**
 * LogmnrProps.Id generated by hbm2java
 */
public class LogmnrProps.Id  implements java.io.Serializable {


     private BigDecimal logmnrUid;
     private String name;

    public LogmnrProps.Id() {
    }

	
    public LogmnrProps.Id(String name) {
        this.name = name;
    }
    public LogmnrProps.Id(BigDecimal logmnrUid, String name) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrProps.Id) ) return false;
		 LogmnrProps.Id castOther = ( LogmnrProps.Id ) other; 
