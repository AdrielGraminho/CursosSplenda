 ...
 * @see com.abctreinamentos.LogmnrGlobal.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrGlobal.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrGlobal$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrGlobal$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrGlobal$")
