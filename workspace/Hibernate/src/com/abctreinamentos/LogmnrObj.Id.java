...
/**
 * LogmnrObj.Id generated by hbm2java
 */
public class LogmnrObj.Id  implements java.io.Serializable {
    ...
    public LogmnrObj.Id(BigDecimal obj#) {
        this.obj# = obj#;
    }
    public LogmnrObj.Id(BigDecimal logmnrUid, BigDecimal obj#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrObj.Id) ) return false;
		 LogmnrObj.Id castOther = ( LogmnrObj.Id ) other; 
