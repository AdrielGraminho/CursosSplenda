...
/**
 * LogmnrTabcompart.Id generated by hbm2java
 */
public class LogmnrTabcompart.Id  implements java.io.Serializable {


     private BigDecimal logmnrUid;
     private BigDecimal obj#;

    public LogmnrTabcompart.Id() {
    }

    public LogmnrTabcompart.Id(BigDecimal logmnrUid, BigDecimal obj#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrTabcompart.Id) ) return false;
		 LogmnrTabcompart.Id castOther = ( LogmnrTabcompart.Id ) other; 
