...
/**
 * Logstdby.plsqlId generated by hbm2java
 */
public class Logstdby.plsqlId  implements java.io.Serializable {
    ...
    public Logstdby.plsqlId() {
    }

    public Logstdby.plsqlId(BigDecimal sessionId, BigDecimal startFinish, Clob callText, BigDecimal spare1, BigDecimal spare2, String spare3) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Logstdby.plsqlId) ) return false;
		 Logstdby.plsqlId castOther = ( Logstdby.plsqlId ) other; 
