...
/**
 * LogmnrCol.Id generated by hbm2java
 */
public class LogmnrCol.Id  implements java.io.Serializable {
    ...
    public LogmnrCol.Id(BigDecimal obj#) {
        this.obj# = obj#;
    }
    public LogmnrCol.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrCol.Id) ) return false;
		 LogmnrCol.Id castOther = ( LogmnrCol.Id ) other; 
