...
public class LogmnrLogmnrBuildlog implements java.io.Serializable {
	...
	private String cdbXid;
	private BigDecimal spare1;
	private String spare2;

	public LogmnrLogmnrBuildlog() {
	}

	public LogmnrLogmnrBuildlog(LogmnrLogmnrBuildlogId id) {
		this.id = id;
	}

	public LogmnrLogmnrBuildlog(LogmnrLogmnrBuildlogId id, String buildDate, BigDecimal dbTxnScnbas,
			BigDecimal dbTxnScnwrp, BigDecimal currentBuildState, BigDecimal completionStatus,
			BigDecimal markedLogFileLowScn, BigDecimal logmnrFlags, String cdbXid, BigDecimal spare1, String spare2) {
		this.id = id;
	...
	public String getCdbXid() {
		return this.cdbXid;
	}

	public void setCdbXid(String cdbXid) {
		this.cdbXid = cdbXid;
	}
