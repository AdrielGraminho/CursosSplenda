 ...
 * @see com.abctreinamentos.LogmnrSessionEvolve.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrSessionEvolve.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrSessionEvolve$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrSessionEvolve$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrSessionEvolve$")
