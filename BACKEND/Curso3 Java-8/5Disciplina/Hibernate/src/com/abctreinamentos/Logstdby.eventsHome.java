 ...
 * @see com.abctreinamentos.Logstdby.events
 * @author Hibernate Tools
 */
public class eventsHome {

    private static final Log log = LogFactory.getLog(Logstdby.eventsHome.class);
    ...
    public events merge(events detachedInstance) {
        ...
        try {
            events result = (events) sessionFactory.getCurrentSession()
    ...
    public events findById( com.abctreinamentos.Logstdby$eventsId id) {
        log.debug("getting events instance with id: " + id);
        try {
            events instance = (events) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Logstdby$events", id);
            if (instance==null) {
    ...
    public List findByExample(events instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Logstdby$events")
