...
/**
 * LogmnrSeed.Id generated by hbm2java
 */
public class LogmnrSeed.Id  implements java.io.Serializable {
    ...
    public LogmnrSeed.Id() {
    }

    public LogmnrSeed.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrSeed.Id) ) return false;
		 LogmnrSeed.Id castOther = ( LogmnrSeed.Id ) other; 
