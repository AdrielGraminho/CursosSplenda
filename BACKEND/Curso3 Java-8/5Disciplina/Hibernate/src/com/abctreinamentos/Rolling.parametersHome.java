 ...
 * @see com.abctreinamentos.Rolling.parameters
 * @author Hibernate Tools
 */
public class parametersHome {

    private static final Log log = LogFactory.getLog(Rolling.parametersHome.class);
    ...
    public parameters findById( com.abctreinamentos.Rolling$parametersId id) {
        log.debug("getting parameters instance with id: " + id);
        try {
            parameters instance = (parameters) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Rolling$parameters", id);
            if (instance==null) {
    ...
    public List findByExample(parameters instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Rolling$parameters")
