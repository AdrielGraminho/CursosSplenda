...
public class LogmnrcGtcs implements java.io.Serializable {
	...
	public LogmnrcGtcs(LogmnrcGtcsId id, BigDecimal segcol#, String colname, BigDecimal type#) {
        this.id = id;
        this.segcol# = segcol#;
