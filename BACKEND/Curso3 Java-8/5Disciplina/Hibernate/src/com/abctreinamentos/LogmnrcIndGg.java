...
/**
 * LogmnrcIndGg generated by hbm2java
 */
public class LogmnrcIndGg implements java.io.Serializable {

	private LogmnrcIndGgId id;
	private String name;
	...
	public LogmnrcIndGg(LogmnrcIndGgId id, String name, BigDecimal baseobj#, BigDecimal baseobjv#, BigDecimal flags, BigDecimal owner#, String ownername) {
        this.id = id;
        this.name = name;
	...
	public LogmnrcIndGg(LogmnrcIndGgId id, String name, BigDecimal dropScn, BigDecimal baseobj#, BigDecimal baseobjv#, BigDecimal flags, BigDecimal owner#, String ownername, BigDecimal spare1, BigDecimal spare2, BigDecimal spare3, String spare4, String spare5, String spare6) {
       this.id = id;
       this.name = name;
	...
	public LogmnrcIndGgId getId() {
		return this.id;
	}

	public void setId(LogmnrcIndGgId id) {
		this.id = id;
	}
