 ...
 * @see com.abctreinamentos.Rolling.status
 * @author Hibernate Tools
 */
public class statusHome {

    private static final Log log = LogFactory.getLog(Rolling.statusHome.class);
    ...
    public status merge(status detachedInstance) {
        ...
        try {
            status result = (status) sessionFactory.getCurrentSession()
    ...
    public status findById( com.abctreinamentos.Rolling$statusId id) {
        log.debug("getting status instance with id: " + id);
        try {
            status instance = (status) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Rolling$status", id);
            if (instance==null) {
    ...
    public List findByExample(status instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Rolling$status")
