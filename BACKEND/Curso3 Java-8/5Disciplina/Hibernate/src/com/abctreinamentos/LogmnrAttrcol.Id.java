...
/**
 * LogmnrAttrcol.Id generated by hbm2java
 */
public class LogmnrAttrcol.Id  implements java.io.Serializable {
    ...
    public LogmnrAttrcol.Id() {
    }

	
    public LogmnrAttrcol.Id(BigDecimal obj#) {
        this.obj# = obj#;
    }
    public LogmnrAttrcol.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrAttrcol.Id) ) return false;
		 LogmnrAttrcol.Id castOther = ( LogmnrAttrcol.Id ) other; 
