...
/**
 * LogmnrIcol.Id generated by hbm2java
 */
public class LogmnrIcol.Id  implements java.io.Serializable {
    ...
    public LogmnrIcol.Id() {
    }

	
    public LogmnrIcol.Id(BigDecimal intcol#) {
        this.intcol# = intcol#;
    }
    public LogmnrIcol.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrIcol.Id) ) return false;
		 LogmnrIcol.Id castOther = ( LogmnrIcol.Id ) other; 
