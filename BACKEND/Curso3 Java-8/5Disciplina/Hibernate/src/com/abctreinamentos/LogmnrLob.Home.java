 ...
 * @see com.abctreinamentos.LogmnrLob.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrLob.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrLob$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrLob$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrLob$")
