 ...
 * @see com.abctreinamentos.LogmnrCol.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrCol.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrCol$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrCol$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrCol$")
