...
/**
 * LogmnrIdnseq.Id generated by hbm2java
 */
public class LogmnrIdnseq.Id  implements java.io.Serializable {
    ...
    public LogmnrIdnseq.Id() {
    }

	
    public LogmnrIdnseq.Id(BigDecimal obj#, BigDecimal intcol#) {
        this.obj# = obj#;
        this.intcol# = intcol#;
    }
    public LogmnrIdnseq.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrIdnseq.Id) ) return false;
		 LogmnrIdnseq.Id castOther = ( LogmnrIdnseq.Id ) other; 
