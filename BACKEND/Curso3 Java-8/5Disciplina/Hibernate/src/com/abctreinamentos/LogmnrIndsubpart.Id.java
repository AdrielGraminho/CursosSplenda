...
/**
 * LogmnrIndsubpart.Id generated by hbm2java
 */
public class LogmnrIndsubpart.Id  implements java.io.Serializable {
    ...
    public LogmnrIndsubpart.Id() {
    }

    public LogmnrIndsubpart.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal pobj#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrIndsubpart.Id) ) return false;
		 LogmnrIndsubpart.Id castOther = ( LogmnrIndsubpart.Id ) other; 
