...
public class MviewWorkloadId implements java.io.Serializable {
	...
	public MviewWorkloadId() {
	}

	public MviewWorkloadId(BigDecimal workloadid, Date importTime, BigDecimal queryid, String owner, String query) {
	...
	public MviewWorkloadId(BigDecimal workloadid, Date importTime, BigDecimal queryid, String application,
			BigDecimal cardinality, BigDecimal resultsize, Date lastuse, BigDecimal frequency, String owner,
			BigDecimal priority, String query, BigDecimal responsetime) {
		this.workloadid = workloadid;
		this.importTime = importTime;
		this.queryid = queryid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MviewWorkloadId))
			return false;
		MviewWorkloadId castOther = (MviewWorkloadId) other;

		return ((this.getWorkloadid() == castOther.getWorkloadid()) || (this.getWorkloadid() != null
				&& castOther.getWorkloadid() != null && this.getWorkloadid().equals(castOther.getWorkloadid())))
				&& ((this.getImportTime() == castOther.getImportTime()) || (this.getImportTime() != null
						&& castOther.getImportTime() != null && this.getImportTime().equals(castOther.getImportTime())))
				...
				&& ((this.getCardinality() == castOther.getCardinality())
						|| (this.getCardinality() != null && castOther.getCardinality() != null
								&& this.getCardinality().equals(castOther.getCardinality())))
				&& ((this.getResultsize() == castOther.getResultsize()) || (this.getResultsize() != null
						&& castOther.getResultsize() != null && this.getResultsize().equals(castOther.getResultsize())))
				&& ((this.getLastuse() == castOther.getLastuse()) || (this.getLastuse() != null
						&& castOther.getLastuse() != null && this.getLastuse().equals(castOther.getLastuse())))
