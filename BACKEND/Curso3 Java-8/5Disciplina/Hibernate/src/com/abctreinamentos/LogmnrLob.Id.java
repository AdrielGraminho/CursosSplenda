...
/**
 * LogmnrLob.Id generated by hbm2java
 */
public class LogmnrLob.Id  implements java.io.Serializable {
    ...
    public LogmnrLob.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrLob.Id) ) return false;
		 LogmnrLob.Id castOther = ( LogmnrLob.Id ) other; 
