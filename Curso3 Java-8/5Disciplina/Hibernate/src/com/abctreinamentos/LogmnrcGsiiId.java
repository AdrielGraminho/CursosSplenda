...
/**
 * LogmnrcGsiiId generated by hbm2java
 */
public class LogmnrcGsiiId implements java.io.Serializable {

	private BigDecimal logmnrUid;
	private BigDecimal obj#;

	public LogmnrcGsiiId() {
	}

	public LogmnrcGsiiId(BigDecimal logmnrUid, BigDecimal obj#) {
	...
	public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrcGsiiId) ) return false;
		 LogmnrcGsiiId castOther = ( LogmnrcGsiiId ) other; 
