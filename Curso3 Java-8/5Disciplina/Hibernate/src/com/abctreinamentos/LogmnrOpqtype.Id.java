...
/**
 * LogmnrOpqtype.Id generated by hbm2java
 */
public class LogmnrOpqtype.Id  implements java.io.Serializable {
    ...
    public LogmnrOpqtype.Id() {
    }

	
    public LogmnrOpqtype.Id(BigDecimal obj#, BigDecimal intcol#) {
        this.obj# = obj#;
        this.intcol# = intcol#;
    }
    public LogmnrOpqtype.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrOpqtype.Id) ) return false;
		 LogmnrOpqtype.Id castOther = ( LogmnrOpqtype.Id ) other; 
