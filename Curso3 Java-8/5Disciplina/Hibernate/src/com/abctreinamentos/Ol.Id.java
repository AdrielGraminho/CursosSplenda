...
/**
 * Ol.Id generated by hbm2java
 */
public class Ol.Id  implements java.io.Serializable {
    ...
    public Ol.Id(String olName, String sqlText, BigDecimal textlen, byte[] signature, BigDecimal hashValue, BigDecimal hashValue2, String category, String version, String creator, Date timestamp, BigDecimal flags, BigDecimal hintcount, BigDecimal spare1, String spare2) {
       this.olName = olName;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Ol.Id) ) return false;
		 Ol.Id castOther = ( Ol.Id ) other; 
