...
/**
 * LogmnrParameter.Id generated by hbm2java
 */
public class LogmnrParameter.Id  implements java.io.Serializable {
    ...
    public LogmnrParameter.Id() {
    }

	
    public LogmnrParameter.Id(BigDecimal session#, String name) {
        this.session# = session#;
        this.name = name;
    }
    public LogmnrParameter.Id(BigDecimal session#, String name, String value, BigDecimal type, BigDecimal scn, BigDecimal spare1, BigDecimal spare2, String spare3) {
       this.session# = session#;
       this.name = name;
       this.value = value;
       this.type = type;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrParameter.Id) ) return false;
		 LogmnrParameter.Id castOther = ( LogmnrParameter.Id ) other; 
