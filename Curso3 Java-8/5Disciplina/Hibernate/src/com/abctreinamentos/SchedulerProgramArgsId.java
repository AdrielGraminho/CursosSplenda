...
/**
 * SchedulerProgramArgsId generated by hbm2java
 */
public class SchedulerProgramArgsId implements java.io.Serializable {
	...
	public SchedulerProgramArgsId() {
	}

	public SchedulerProgramArgsId(String owner, String programName, BigDecimal argumentPosition) {
		this.owner = owner;
		this.programName = programName;
		this.argumentPosition = argumentPosition;
	}

	public SchedulerProgramArgsId(String owner, String programName, String argumentName, BigDecimal argumentPosition,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SchedulerProgramArgsId))
			return false;
		SchedulerProgramArgsId castOther = (SchedulerProgramArgsId) other;
