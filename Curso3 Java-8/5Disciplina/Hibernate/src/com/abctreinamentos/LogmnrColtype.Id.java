...
/**
 * LogmnrColtype.Id generated by hbm2java
 */
public class LogmnrColtype.Id  implements java.io.Serializable {
    ...
    public LogmnrColtype.Id() {
    }

	
    public LogmnrColtype.Id(BigDecimal obj#) {
        this.obj# = obj#;
    }
    public LogmnrColtype.Id(BigDecimal logmnrUid, BigDecimal obj#, BigDecimal intcol#) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrColtype.Id) ) return false;
		 LogmnrColtype.Id castOther = ( LogmnrColtype.Id ) other; 
