 ...
 * @see com.abctreinamentos.LogmnrGtUserInclude.
 * @author Hibernate Tools
 */
public class Home {

    private static final Log log = LogFactory.getLog(LogmnrGtUserInclude.Home.class);
    ...
    public  findById( com.abctreinamentos.LogmnrGtUserInclude$Id id) {
        log.debug("getting  instance with id: " + id);
        try {
             instance = () sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.LogmnrGtUserInclude$", id);
            if (instance==null) {
    ...
    public List findByExample( instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.LogmnrGtUserInclude$")
