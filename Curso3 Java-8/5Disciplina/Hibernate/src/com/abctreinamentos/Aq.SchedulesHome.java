 ...
 * @see com.abctreinamentos.Aq.Schedules
 * @author Hibernate Tools
 */
public class SchedulesHome {

    private static final Log log = LogFactory.getLog(Aq.SchedulesHome.class);
    ...
    public void persist(Schedules transientInstance) {
        log.debug("persisting Schedules instance");
        try {
    ...
    public Schedules merge(Schedules detachedInstance) {
        ...
        try {
            Schedules result = (Schedules) sessionFactory.getCurrentSession()
    ...
    public Schedules findById( com.abctreinamentos.Aq$SchedulesId id) {
        log.debug("getting Schedules instance with id: " + id);
        try {
            Schedules instance = (Schedules) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Aq$Schedules", id);
            if (instance==null) {
    ...
    public List findByExample(Schedules instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Aq$Schedules")
