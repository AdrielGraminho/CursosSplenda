 ...
 * @see com.abctreinamentos.Rolling.plan
 * @author Hibernate Tools
 */
public class planHome {

    private static final Log log = LogFactory.getLog(Rolling.planHome.class);
    ...
    public plan merge(plan detachedInstance) {
        ...
        try {
            plan result = (plan) sessionFactory.getCurrentSession()
    ...
    public plan findById( com.abctreinamentos.Rolling$planId id) {
        log.debug("getting plan instance with id: " + id);
        try {
            plan instance = (plan) sessionFactory.getCurrentSession()
                    .get("com.abctreinamentos.Rolling$plan", id);
            if (instance==null) {
    ...
    public List findByExample(plan instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.abctreinamentos.Rolling$plan")
