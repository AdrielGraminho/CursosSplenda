...
/**
 * Mview.AdvInfoId generated by hbm2java
 */
public class Mview.AdvInfoId  implements java.io.Serializable {


     private BigDecimal runid#;
     private BigDecimal seq#;

    public Mview.AdvInfoId() {
    }

    public Mview.AdvInfoId(BigDecimal runid#, BigDecimal seq#) {
       this.runid# = runid#;
       this.seq# = seq#;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Mview.AdvInfoId) ) return false;
		 Mview.AdvInfoId castOther = ( Mview.AdvInfoId ) other; 
